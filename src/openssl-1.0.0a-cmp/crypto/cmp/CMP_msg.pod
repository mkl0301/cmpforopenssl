...
This is the API for creating different CMP related PKIMESSAGES. The functions allocate a new message and fill it with the relevant data from the given CMP_CTX.
...
All of the functions return a new CMP_PKIMESSAGE structure containing the generated message.
