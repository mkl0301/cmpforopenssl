...
CMP_POPO_SIGNATURE - according to RFC 4211, section 4.1 (only case 3 supported so far)
CMP_POPO_ENCRCERT  - according to RFC 4211, section 4.2 with the indirect method (subsequentMessage/enccert)
