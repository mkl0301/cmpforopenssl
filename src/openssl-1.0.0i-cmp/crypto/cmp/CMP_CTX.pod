...
=head1 NAME
 ...
 CMP_CTX_set1_protectionAlg,
 CMP_CTX_set_protectionAlg,
...
CMP_CTX_set1_protectionAlg() sets the protection algorithm, which
...
CMP_CTX_set_protectionAlg() sets the given definition (CMP_ALG_PBMAG
