...
=head1 NAME
  ...
  CMP_PKIHEADER_set1,
  CMP_PKIHEADER_set1_protectionAlg,
...
CMP_PKIHEADER_set1_protectionAlg() sets hdr->protectionAlg to the
...
CMP_get_protectionAlg_by_nid() creates an X509_ALGOR structure based
