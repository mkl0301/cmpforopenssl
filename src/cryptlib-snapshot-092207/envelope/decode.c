...
#if 0	/* This check doesn't seem to serve any useful purpose since EOCs
		   are handled at a higher level.  In particular the check for a 
		   single pair of EOCs produces false positives when there's a 
